...
router.post('/edit',async function (req, res) {
  var career = await report_careerModel.findOne({carid : req.body.carid});
        report_careerModel.findByIdAndUpdate(career._id, req.body, {new: true}, function (err, UpdatedDetails) {
...
router.post('/delete',async function (req, res) {
  await report_careerModel.findByIdAndDelete(req.body._id, function (err, user) {
          if (err) return res.json({Status:"Failed",Message:"Internal Server Error", Data : {},Code:500});
