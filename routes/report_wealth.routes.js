...
router.post('/edit',async function (req, res) {
  var wealth = await report_wealthModel.findOne({weid : req.body.weid});
        report_wealthModel.findByIdAndUpdate(wealth._id, req.body, {new: true}, function (err, UpdatedDetails) {
...
router.post('/delete',async function (req, res) {
  await report_wealthModel.findByIdAndDelete(req.body._id, function (err, user) {
          if (err) return res.json({Status:"Failed",Message:"Internal Server Error", Data : {},Code:500});
